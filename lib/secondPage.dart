...
class SecondRouteState extends State<SecondRoute> {
  ...
  List<Intrebare> intrebari = [
    Intrebare(
        ...
        answers: [
          Answer(ans: 11, value: false),
          Answer(ans: 10, value: false),
          Answer(ans: 12, value: false),
          Answer(ans: 9, value: false),
        ],
        correct: 11),
    Intrebare(
        ask:
        ...
        answers: [
          Answer(ans: 13, value: false),
          Answer(ans: 12, value: false),
          Answer(ans: 14, value: false),
          Answer(ans: 11, value: false),
        ],
        correct: 11),
    Intrebare(
    ...
    Intrebare(
        ...
        answers: [
          Answer(ans: 11, value: false),
          Answer(ans: 0, value: false),
          Answer(ans: 33, value: false),
          Answer(ans: 4, value: false),
        ],
        correct: 0),
    Intrebare(
        ask:
            'Add the Decimals 5+8',
        answers: [
          Answer(ans: 14, value: false),
          Answer(ans: 12, value: false),
          Answer(ans: 13, value: false),
